...
contract InvariantTest is Test {
    ...
    /// @dev Authorization property: a non-Nursery can NEVER issue, for any inputs.
    function testFuzz_OnlyTestCenterCanIssue(address caller, bytes32 id, bytes32 h, address owner_) public {
        ...
        vm.assume(!issuers.isNursery(caller));
        vm.prank(caller);
        vm.expectRevert(RecordRegistry.NotNursery.selector);
        records.registerPlanting(id, h, "cid", owner_, "meta");
    }
